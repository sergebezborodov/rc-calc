...
class H
{
     ...
     * @return string папку пользователя
     */
    public static function getStoragePathForUser(UserModel $user)
    {
        $storage = Yii::getPathOfAlias(Y::param('storage.path')) . DS . $user->hash;
     ...
     * @return string
     */
    public static function getUrlToUserStorage(UserModel $user)
    {
        return '/storage/' . $user->hash . '/';
    }
}
